...
export default function ClinicDetails() {
  ...
  if (!clinic) return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-4">
      <h2 className="text-2xl font-bold text-slate-900">{t('clinics.not_found_title')}</h2>
      <Link to="/clinics" className="text-teal-700 flex items-center gap-2 hover:underline">
        <FiArrowLeft size={16} /> {t('clinics.back')}
      </Link>
    </div>
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl border border-slate-100 p-6">
                  <h2 className="font-bold text-slate-900 text-lg mb-4">{t('tabs.insurance_accepted')}</h2>
                  <div className="flex flex-wrap gap-2">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-teal-50 border border-teal-100 rounded-2xl p-5 text-center">
              <p className="text-sm font-semibold text-teal-800 mb-1">{t('contact.need')}</p>
              <p className="text-xs text-teal-600 mb-3">{t('contact.call')}</p>
